...
<?PHP 
$attendance_count=$db->query_first("select count(*) as attcount from attendance_entry");
$daily_count=$db->query_first("select count(*) as dailycount from daily_expense");
$log_count=$db->query_first("select count(*) as logcount from log_book");
?>
