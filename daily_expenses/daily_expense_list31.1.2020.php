...
//if($staff_id!=""){ $staff_id1 = "staff_id='$staff_id'";}else{$staff_id1='';}
...
echo $sess_user_type_id=$_SESSION['sess_user_type_id'];
...
$sess_ipaddress=$_SESSION['sess_ipaddress'];
								...
								{
                                 $sql = "SELECT * FROM daily_expense where $get_query delete_status!='1' and staff_id='$sess_staff_id'";
								}
								else
								{
								...
								?>
                                    <tr>
                                        ...
                                        -->
                                         <td align="center">
                                           <a   href="javascript:machinerie_print('daily_expenses/image_list.php?invoice_no=<?php echo $record['expense_no']; ?>&random_no=<?php echo $record['random_no'] ?>&random_sc=<?php echo $record['random_sc'];?>&id=<?php echo $record['exp_id'];?>')" style="float:center"><img  align="center" src="images/view-icon.png" width="30" height="30" border="0" /></a></td>
