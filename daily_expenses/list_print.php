...
<div>
  <table id="bootstrap-data-table" class="table" width="100%">
    ...
    <tr>
      ...
      <td width="50%" align="center" class="style2">Expense Type : <strong><?php if($_GET['exp_type_id']==''){ echo "All";} else { echo get_expense_type($_GET['exp_type_id']); }?></strong></td>
    </tr>
  </table>
  <br>
</div>
