                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th width="21%" ><div align="center">Location</div></th>
                                      <th width="21%" ><div align="center">Image</div></th>
...
$sess_ipaddress=$_SESSION['sess_ipaddress'];
								...
								?>
                                    <tr>
                                        ...
                                        <td align="center">
                                            <?php if($record['image_name']!='') { ?>
                                           <a   href="javascript:attendance_image('attendance_creation/image_list.php?invoice_no=<?php echo $record['attendance_no']; ?>&random_no=<?php echo $record['random_no'] ?>&random_sc=<?php echo $record['random_sc'];?>&id=<?php echo $record['att_id'];?>')" style="float:center"><img  align="center" src="images/view-icon.png" width="30" height="30" border="0" /></a>
                                       <?php } ?>
                                       </td>
