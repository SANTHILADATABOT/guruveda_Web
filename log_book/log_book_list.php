...
<table id="bootstrap-data-table" class="table" width="100%">
                            <thead>
                                <tr>
									...
									<th width="5%" ><div align="center">Openning Location</div></th>
									<th width="5%" ><div align="center">Closing Location</div></th>
...
$sess_ipaddress=$_SESSION['sess_ipaddress'];
								...
								$staff_longitude_closing=$record['closing_longitude'];
								$staff_latitude_closing=$record['closing_latitude'];
								
								?>
                                    <tr>
                                        <td><?php echo $i=$i+1;?></td>
                                        <td><?php echo get_user_name($record['sales_ref_id']);?></td>
									  ...
									  <td><?php echo $record['litres'];?></td>
                                        <td><?php echo number_format($record['amount'],2);?></td>
                                         ...
                                         <td align="center">
                                         	<?php if( ( $record['image_name']!='')  || ($record['closing_km_img']!='') ) { ?>
                                           <a   href="javascript:files_print('log_book/image_list.php?log_id=<?php echo $record['log_id']; ?>')" style="float:center"><img  align="center" src="images/view-icon.png" width="30" height="30" border="0" /></a>
                                       <?php } ?>
                                       </td>
                                        ...
                                        <td><?php if(($staff_longitude_closing!='')&&($staff_latitude_closing!='')) {?>
                                        <div align="center">
                                        <a onclick="print_map('log_book/map.php?staff_latitude=<?php echo $staff_latitude_closing; ?>&staff_longitude=<?php echo $staff_longitude_closing; ?>');" target="new">
                                        <img src="images/map.png" height="30" width="30">
                                        </a></div><?php }?>
                                        </td>
